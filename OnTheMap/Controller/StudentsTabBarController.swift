...
class StudentsTabBarController: UITabBarController {
    ...
    override func viewDidLoad() {
        ...
        guard let tableViewController = viewControllers!.last as? StudentsTableViewController,
            let mapViewController = viewControllers!.first as? StudentsMapViewController else {
